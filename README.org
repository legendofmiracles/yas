...
* Security
    ...
    yas will ask for the password whenever you want to run a command privileged, unless you ran a command with yas in the last 5 minutes.
    Note however, that this is cross terminal, but i am planning on fixing that.
